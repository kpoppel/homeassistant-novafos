'''
All model classes for pynovafos
'''
...
class TimeSeries:
    ...
    '''
    def __init__(self, status, data_date, metering_data, total_metering_data, detailed_status=None):
        self._status = status
    ...
    def set_total_metering_data(self, total):
        self._total_metering_data = total

    def get_total_metering_data(self):
        return self._total_metering_data